...
const QUERIES = QUERY_ARG ? [QUERY_ARG] : [
    ...
    'higiene-y-belleza/afeitado',
    'higiene-y-belleza/cosmeticos',
    'higiene-y-belleza/cuidado-bucal',
    'higiene-y-belleza/cuidado-del-cabello',
    'higiene-y-belleza/cuidado-facial',
    'higiene-y-belleza/cuidado-intimo',
    'higiene-y-belleza/cuidado-para-pies',
    'higiene-y-belleza/higiene-y-cuidado-corporal',
    'higiene-y-belleza/higiene-y-cuidado-para-manos',
    'higiene-y-belleza/kits-de-viaje',
    'higiene-y-belleza/panuelos-desechables',
    'jugos-y-bebidas',
